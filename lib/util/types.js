...
class Content extends Structure {
    ...
    /** @type {API} */
    #api = new API({tabnewsUrl: "https://www.tabnews.com.br"})
    /** @type {boolean} */
    #fetched;
    /** @type {UserData} */
    #ownerData;
    ...
    fetchParent(){
        return new Promise((resolve, reject) => {
            ...
            this.#api.request(`${this.#api.endpoints.content}/${this.owner.username}/${this.id}/parent/`).then(res => {
                ...
                throw new tabNewsHttpError(err, this.#api.getUrlOfEndpoint(`${this.#api.endpoints.content}/${this.owner.username}/${this.id}/parent/`))
            })
        })
    }
